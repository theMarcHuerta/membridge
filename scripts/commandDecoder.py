        ...
        m.d.sync += [
            If(self.rst,
                ...
                Case(Cat(self.mem_read, self.mem_write, self.activate, self.precharge, self.refresh), {
                    0b10000: self.cmd_decoded.eq(self.command_encoding['READ']),
                    0b01000: self.cmd_decoded.eq(self.command_encoding['WRITE']),
                    0b00100: self.cmd_decoded.eq(self.command_encoding['ACTIVATE']),
                    0b00010: self.cmd_decoded.eq(self.command_encoding['PRECHARGE']),
                    0b00001: self.cmd_decoded.eq(self.command_encoding['REFRESH']),
